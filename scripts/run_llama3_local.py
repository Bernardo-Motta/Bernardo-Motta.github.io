"""
Teste local — Llama 3 (8B), quantizado, via Ollama
====================================================
...
Pré-requisitos:
  ...
  2. Baixar o modelo:          ollama pull llama3:8b
  3. Instalar a biblioteca:    pip install ollama

Uso:
  python run_llama3_local.py            # roda todas as tarefas de exemplo
  python run_llama3_local.py simplificacao   # roda só uma tarefa
"""
